			...
			<div class="row">
				<?php
					...
					<form action="process.php" method="POST" class="col s12" id="addevent">
						...
						<div class="row">
							<div class="input-field col s12">
								<input placeholder="seats needed" id="seats" type="text"  name="seats" maxlength="30" value="<?php if (isset($_GET['s'])) echo $_GET['s']; ?>">
							</div>
						</div>
...
function makeTable($num, $desc, $msg, $bg, $date, $conflict){
	...
	echo '<div class="cutoff"><input type="radio" name="room" value="'.$num.'"><label>Room: '.$num.'';
